    ...
    async prepareData(assessmentData) {
      ...
      try {
        ...
        for (const rawdata of flattenedBreedingInfo) {
          ...
          // const rawStartDate = rawdata["Assessment"].Show.Date.Start;

          // const processedShowName = this.removeDateAfterComma(rawShowName);
          // const formattedStartDate = parseDate(rawStartDate); // Use parseDate utility
          // const key = `${processedShowName}_${formattedStartDate}`;
